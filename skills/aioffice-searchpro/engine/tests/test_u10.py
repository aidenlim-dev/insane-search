#!/usr/bin/env python3
"""U10 regression tests — cross-platform yt-dlp invocation resolution.

(Upstream insane-search calls this suite U9; renumbered to U10 here because
this fork's U9 already covers Playwright tier routing.)
